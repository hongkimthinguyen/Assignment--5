...
def learn():
    ...
    return ("In ENSF 692, I discovered that Python is highly potent for data analysis and comparatively easier to learn in terms of syntax than other languages")
